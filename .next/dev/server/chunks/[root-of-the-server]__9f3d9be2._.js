...
async function POST(request) {
    try {
        ...
        if (body.projectId && body.type === "EXPENSE") {
            ...
            if (project) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.update({
                    where: {
                        id: body.projectId
                    },
                    data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9f3d9be2._.js.map