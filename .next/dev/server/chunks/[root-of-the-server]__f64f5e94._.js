...
async function GET(request) {
    try {
        ...
        const clients = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].client.findMany({
            where: status ? {
                status: status
            } : undefined,
            orderBy: {
...
async function POST(request) {
    try {
        ...
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].client.create({
            data: {
                name: body.name,
                email: body.email,
                phone: body.phone,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f64f5e94._.js.map